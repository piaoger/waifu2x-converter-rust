...
impl Image {
	...
	// For better color space conversion, we can look into python PIL which uses a
	// Table based method. https://github.com/hobson/pil/blob/master/libImaging/ConvertYCbCr.c
